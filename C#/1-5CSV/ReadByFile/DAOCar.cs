...
namespace ReadByFile
{
    internal class DAOCar:IDAO
    {
        ...
        private static string[] info = File.ReadAllLines("../../../Values.txt");
        /*
        ...
        */
        ...
        private string[] carSedili=new string[info.Length];
        ...
        */
        void IDAO.AddValues()
        {
            ...
            {
                cars.Add(new Car(id[i], carName[i], carColor[i], carPlate[i], carSedili[i]));
